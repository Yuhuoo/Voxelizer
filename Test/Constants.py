...
class Constants:
    def __init__(self):
        ...
        self.meshNormMargin = 0.45 # margin when normalizing mesh into H [-0.5,0.5]*(1-margin), W/D [-0.333,0.333]*(1-margin)
        # self.threshH1 = self.h_normalize_half * (1-self.meshNormMargin)
        # self.threshWD1 = self.h_normalize_half * self.dim_w/self.dim_h * (1-self.meshNormMargin)
        # self.threshH = self.h_normalize_half * (1-self.meshNormMargin)
        # self.threshWD = self.h_normalize_half * (1-self.meshNormMargin)
        self.threshH = 0.3
        self.threshWD = 0.3
